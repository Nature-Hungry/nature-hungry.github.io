---
title: "Introducing snails with shells on Singapore shores"
description: "Fact sheet with photos on flora and fauna of Singapore's intertidal shores"
keywords: "snail, gastropod, shell, mollusca, field, guide, seashore, sea, shore, marine, coastal, intertidal, singapore, facts, fact sheet, info"
layout: default
---
...
shelled
snails [text index](gastropodaindex.htm) | [photo
index](gastropodafi.htm)
Phylum
[Mollusca](mollusca.htm) > Order [Gastropoda](gastropoda.htm)
[index
to talking points](../forguides/index.html) for nature guides
**For
nature guides: introducing snails with shells**  
*updated
Oct 2016*
...
- The shapes
  ...
  - Smooth
    shiny shells: [cowries](gastropoda/cypraeidae/cypraeidae.htm)
    have shiny shells because they cover the shell with their
    body.
  - Textured
    shells: The tiny bumps on [knobbly
    periwinkles](gastropoda/littorinidae/nodilittorina.htm) are believed to help keep it cool.
  - Round
    shells: [Nerite
    snails](gastropoda/neritidae/neritidae.htm) are hard to grip and bounce away from slippery
    crab pincers to escape among the rocks.
  - Spikes
    may help deter predators: [murex
    snail](gastropoda/muricidae/trapa.htm), [spider
    conch](gastropoda/strombidae/lambis.htm)
  - The flared
    lip of a [conch](gastropoda/strombidae/strombidae.htm)
    helps prevent it from flipping over as it hops
  - Long
    tips protect the siphon: [spiral
    melongena](gastropoda/melogenidae/cochlidium.htm)
  - Did you
    know some snails have hairy shells?! The hairy shell of a
    living [spiral
    melongena](gastropoda/melogenidae/cochlidium.htm) traps sediments for camouflage. When it dies,
...
- ***There's
  ...
  - **Different
    ...
    - Is
      it thin and narrow?(e.g. [dove
      snails](gastropoda/columbellidae/columbellidae.htm), [cowries](gastropoda/cypraeidae/cypraeidae.htm))
  - **Shutting
    ...
    - Is
      ...
      snails](gastropoda/turbinidae/turbinidae.htm))
    - Or
      thin and flexible? Can be retracted deep into a coiling
      shell. (e.g., [top
      shell snails](gastropoda/trochidae/trochidae.htm))
    - Door
      with a lock! [Nerite
      snails](gastropoda/neritidae/neritidae.htm) can lock their door shut!
  - **Shutting
    the door and hanging on at the same time.**
  - At low
    tide, [periwinkles](gastropoda/littorinidae/littorinidae.htm)
...
- ***Let's
  ...
  - How speedy
    can snails get? Pretty fast if it's a [whelk](gastropoda/nassariidae/nassariidae.htm)
    going after the recent dead.
  - Can a
    snail hop? Yes it can if it's a [conch](gastropoda/strombidae/strombidae.htm).
  - Buldozing
    burrowers: see how the [moon
    snail](gastropoda/naticidae/naticidae.htm) uses its oversized body to plough through the wet
    sand.
  - It has
    a pair of tentacles. Look also for the operculum. And other
    special body parts.
  - Some
    have a very long siphon to sniff out food (e.g, [whelks](gastropoda/nassariidae/nassariidae.htm))
  - Some
    snails cover their shells with their body (e.g [cowries](gastropoda/cypraeidae/cypraeidae.htm),
    [moon snails](gastropoda/naticidae/naticidae.htm))
  - Some
    snails don't move at all. Some [mother
    cowries](gastropoda/cypraeidae/cypraeidae.htm) stay over their eggs to protect them. Other snails
...
- ***What
  ...
  - Egg capsules
    protect baby snails (e.g., [spiral
    melongena](gastropoda/melogenidae/cochlidium.htm), [noble
    volute](gastropoda/volutidae/nobilis.htm), [nerite
    snails](gastropoda/neritidae/neritidae.htm), [drills](gastropoda/muricidae/muricidae.htm))
  - Egg mass
    may look very strange (e.g., [sand
    collar of moon snail](gastropoda/naticidae/sandcollar.htm))
  - An intact
    sand collar contains thousands of living eggs. The collar
    disintegrates with the babies hatch. So please don't destroy
    sand collars or egg capsules!
...
- Some common
  ...
  - [Limpets](gastropoda/limpets/limpet.htm)
  - [Slipper
    snails](gastropoda/calyptraeidae/crepidulidae.htm)
  - [Worm
    snails](gastropoda/vermetidae/vermetidae.htm)
...
- ***Snail
  ...
  crabs](../crustacea/fnghermitcrabs.htm) have a soft backside and must insert this into an empty
...
- Do you
  ...
  tide and other harmful algal blooms](../plants/seaweed/redtide.htm), etc and thus why they
